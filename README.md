...
- Automated email sending, HubSpot sync, and AI enrichment are not included. Google Places discovery and optional Apollo decision-maker enrichment are available when their server-only keys are configured.
